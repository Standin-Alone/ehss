...
<body class="pace-top bg-white">
	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-with-news-feed">
            <!-- begin news-feed -->
            <div class="news-feed">
                <div class="news-image" style="background-image: url(assets/wasd.jpeg)"></div>
                <div class="news-caption">
                    <h3 class="caption-title"><b>Environment, Health, Safety and Security</b></h3>
                    <!-- <p>
            ...
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class=""></span> <img src="assets/fav.png" style="width:30px; height:30px;"><b> EHSS</b> System 
                        <small>Send reports to us.</small>
                    </div>
                    <div class="icon">
                ...
                <div class="login-content">
                    <form action="index.html" method="GET" class="margin-bottom-0">
                        ...
                        <p class="text-center text-grey-darker">
                            &copy; Philippine Nuclear Research Institute 2022
                        </p>
                    </form>
                </div>
                <!-- end login-content -->
