    ...
    <div class="page-content-wrapper">
        <div class="page-content">
                    ...
                    <form id="ftrDTR" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-md-9"><br>
                                ...
                                <div class="form-group dtradmin hidme revme">
                                ...
                                <div class=""><center>
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        ...
                                        <button id="btnPrint" type="button" class="btn btn-default hidden" onclick="javascript:window.print()">Print</button>
                                    </div></center>
                                </div>
                            </div>
            ...
            <!-- <div class="portlet light"> -->
                <div class="portlet-body form" id="dtrbody">
                </div>
...
function showDTR(){
    allowArrowKeys = 1;
    $(".divbtnEdit").hide();
    $('#dtrbody').html("<center><span><img src='<?php echo base_url('assets/spinner.gif');?>'/> Please wait...</span></center>");
    ...
    ({  type:"GET",
        ...
        success: function(data)
        {
            if(data[0]){
                ...
                $('#dtrbody').html("<center>No record.</center>");
