...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #1b262c; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 16px; line-height: 22.4px; font-weight:bold; ">Provide support to emergency operations. Coordinate with the PERT/PIRT to perform response operations in compliance with the directives of the EMT.</span></p>
  </div>
