...
<nav class="portal" style="position: fixed;top: 0;z-index: 9;">
    <ul class="portal">
		...
		<li class="portal  <?php echo ($uriSegments[1] == 'infosys'?'active':'');?>" style="width: 235px;"><img src="<?php echo base_url('/assets/login/logo.png')?>" width="30" height="30" style="margin-left: 10px;"><a href="#">PNRI Infosys</a></li>
		<?php
			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				<li class="start <?php if ($menu == 'dashboard') echo  ' active open';?> mmenu">
					...
					<li class="<?php if ($gmenu == 'main' || $gmenu == 'payment') echo  ' open';?> mmenu">
						...
						<li class="<?php if ($menu == 'employees') echo  'start active open';?> limenu HRreports hidden hidme revme divabled">
						...
						<li class="<?php if ($gmenu == 'attendance') echo  ' active ';?> open">
							...
							<ul class="sub-menu" style="display: block;">
								...
								<li class="<?php if ($menu == 'wfh') echo  'start active open';?> limenu">
									<a href="<?php echo base_url('hr/wfh');?>">
									<span class="title">WFH Reports</span>
									</a>
								</li>
								<?php //if(in_array($this->session->userdata('uroles'), array("34","7","35"))){ ?>
								<?php if(count(array_intersect($this->session->userdata('uroles'), array("3","7","34","35"))) > 0){ ?>
								<li class="<?php if ($menu == 'wfhsub') echo  'start active open';?> limenu">
									<a href="<?php echo base_url('hr/wfh/submissions');?>">
									<span class="title">WFH Submissions</span>
									</a>
								</li>
								<?php } ?>
							</ul>
...
<?php
		...
		$div = $this->session->userdata('division');
						...
						echo
						'<li class="'. ($menu == 'leave' || $menu  == 'leave_applications'?' active ':'').' open ">
							<a href="javascript:;">
							<i class="fa fa-child"></i> Leave <span class="arrow"></span>
							</a>
							<ul class="sub-menu" style="display: block;">
								<li class="'. ($menu == 'leave'?'start active open':'').' limenu">
									<a href="'. base_url('hr/leave').'">
									Apply Leave</a>
								</li>';

						echo  ($sect == 20 || $div == 12 || $div == 15 || $this->session->userdata('id') == 409 ?
								'<li class="'.($menu == 'leave_applications'?'start active open':'').' limenu">
									<a href="'. base_url('hr/leave/leave_applications') .'">
	...
	?>
						...
						<li class="<?php if ($menu == 'announcement') echo  'start active open';?> limenu hrmo revme">
							<a href="<?php echo base_url('hr/announcements');?>">
							<i class="fa fa-bullhorn fa-align-justify"></i>
							Announcements</a>
						</li>
				<li class="start <?php if ($menu == 'survey') echo  ' active open';?> mmenu">
					<a href="<?php echo base_url('survey/');?>">
						<i class="fa fa-file-text-o"></i>
						<span class="title">Satisfaction Survey</span>
						<span class="badge badge-roundless badge-success">new</span>
					</a>
				</li>
				<li class="open">
					<a href="javascript:;">
					<i class="fa fa-external-link"></i> Other Sites <span class="arrow"></span>
					</a>
					<ul class="sub-menu" style="display: block;">
						<li><a target="_blank" href="https://pnri.dost.gov.ph/">PNRI Website</a></li>
						<li><a target="_blank" href="https://pnridostgovph.sharepoint.com/sites/pnri-all/">Cloud Intranet</a></li>
						<li><a target="_blank" href="https://admin.services.pnri.dost.gov.ph/intranet/Consultation/">Itanong mo kay Dok</a></li>
						<li><a target="_blank" href="https://portal.office.com/">Office 365</a></li>
						<li><a target="_blank" href="https://owncloud.pnri.dost.gov.ph/">OwnCloud</a></li>
						<li><a target="_blank" href="https://www.facebook.com/PNRIDOST">PNRI FB</a></li>
						<li><a target="_blank" href="ftp://ftp.intranet.pnri/">FTP</a></li>
					</ul>
				</li>

					<!-- BEGIN EHSS SIDEBAR MENU -->
