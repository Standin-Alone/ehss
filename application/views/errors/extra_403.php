...
<head>
<meta charset="utf-8"/>
<title>Payroll | Error - 403 Access forbidden</title>
...
<div class="page-inner">
	<img src="<?php echo base_url();?>assets/admin/pages/media/pages/earth.jpg" class="img-responsive" alt="">
</div>
<div class="container error-404">
	...
	<p>
		 If you think this is a server error, please contact the MISS (loc. 280)
	</p>
	<p>
		<a href="<?php echo base_url('access');?>"><i class="fa fa-chevron-circle-left"></i> Go Back </a>
		<br>
	</p>
</div>
